...
let formatPrefixFn = d3.formatPrefix('*^+25,~s', 1e-3);
console.log(formatPrefixFn(value1));
console.log(formatPrefixFn(value2));

formatPrefixFn = d3.formatPrefix('*^+25,~s', 1e3);
console.log(formatPrefixFn(value1));
console.log(formatPrefixFn(value2));

formatPrefixFn = d3.formatPrefix('*^+25,~', 1e3);
console.log(formatPrefixFn(value1));
console.log(formatPrefixFn(value2));
...
// d3.formatSpecifier
let formatSpecifier = d3.formatSpecifier('*^+$25,~s');
