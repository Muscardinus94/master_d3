...
Object.values(ugEnroll).forEach((obj) => female.push(obj.female));
Object.values(ugEnroll).forEach((obj) => male.push(obj.male));
...
// legend
document.getElementById('legend').querySelector('p').style.color = scaleColor(
  'female'
);
document
  .getElementById('legend')
  .querySelector('p:nth-of-type(2)').style.color = scaleColor('male');
