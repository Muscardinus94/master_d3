  ...
  d3.select('#years')
    ...
    .on('click', function (e, d) {
      ...
      d3.select('#quarters svg')
        ...
        .attr('y', (d, i) => {
          return (
            (document.querySelector('#quarters svg').clientHeight / 6) *
              (i + 1) +
      ...
      d3.select('#vehicles p').text(
        'Hover on a quarterly bar for vehicle types'
      );
      ...
      d3.select('#quarters svg')
        ...
        .on('mouseenter', function (e, d) {
          ...
          d3.select('#vehicles svg')
            ...
            .style('fill', (d, i) => {
              if (i === 0) return '#38ACEC';
              if (i === 1) return '#79BAEC';
              if (i === 2) return '#A0CFEC';
            });
          ...
          d3.select('#vehicles svg')
            ...
            .text((d, i) => {
              if (i === 0) return 'Trucks | ' + d;
              if (i === 1) return 'SUV | ' + d;
              if (i === 2) return 'Cars | ' + d;
            })
            .style('font-size', '12')
            .style('font-weight', '500')
            .style('fill', 'gray');
