...
function updateCont(selectedMovies) {
  ...
  d3.select('#cont').selectAll('div').remove();
  ...
  selectedMovies.forEach(function (movie) {
    if (movie.contentRating === 'U') countU += 1;
    else if (movie.contentRating === '15') count15 += 1;
    else if (movie.contentRating === '12A') count12A += 1;
    else if (movie.contentRating === 'PG') countPG += 1;
  });
